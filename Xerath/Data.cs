...
namespace Xerath
{
    internal partial class MyScript
    {
        ...
        internal static void LoadData()
        {
            ...
            Q.SetValues(0.8f, float.PositiveInfinity, 180f, 750, 1500, "XerathArcanopulseChargeUp", SkillshotType.SkillshotLine);

            W = new SpellManager(w, SpellSlot.W, TargetSelector.DamageType.Magical);
            W.SetValues(1f, float.PositiveInfinity, 500f, 1100f, SkillshotType.SkillshotCircle);

            E = new SpellManager(e, SpellSlot.E, TargetSelector.DamageType.Magical, SpellManager.CollisionTable.Normal);
            E.SetValues(0.3f, 1600f, 140f, 1050, SkillshotType.SkillshotLine);

            R = new SpellManager(r, SpellSlot.R, TargetSelector.DamageType.Magical);
            R.SetValues(0.6f, float.PositiveInfinity, 400f, 0f, SkillshotType.SkillshotCircle);
